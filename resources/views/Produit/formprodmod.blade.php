            ...
            <div class="row" class="mt-3">
                ...
                @endforeach
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" id="qtte" name="qtte" value="{{$produits->qtte}}" placeholder="Entrer la quantite en stock">
                        </div>
                        </div>

                        <div class="form-outline" data-mdb-input-init>
                        <label class="form-label" for="description">description</label>
    <textarea class="form-control" id="description" value="{{$produits->description}}" name="description" rows="4"></textarea>
    </div>
    <div class="mb-3 ">
